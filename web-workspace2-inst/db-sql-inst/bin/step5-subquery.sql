...
-- 1) 상품 최고가격을 조회 
SELECT MAX(price) FROM product; -- 2200 
...
SELECT name,maker,price FROM product
...
(select min(salary) from employee where job='총무')

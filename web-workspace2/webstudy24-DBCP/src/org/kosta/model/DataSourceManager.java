 ...
 * 	javax.sql.DataSource는 Interface 타입으로 DBCP를 관리한다. 이유는 WAS가 변경되면 DBCP도 변경될 수 있으므로 추상화된 인터페이스 타입으로 관리하는 것이 유지보수에 유리하다. 
 */
public class DataSourceManager {
	...
	private DataSourceManager() {
		...
		dbcp.setInitialSize(3);//처음 로드될 때 생성해 놓을 커넥션 수
		dbcp.setMaxTotal(10);//최대 커넥션 수: 기본은 8이다.
